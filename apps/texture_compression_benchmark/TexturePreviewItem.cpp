...
constexpr std::array<GpuPreview, 13> gpu_previews { {
    { "Search 0",
    ...
    { "split fused",
        ...
        0 },
    { "split fused projection",
        "Selects modifiers from the RGB projection relative to each decoded base colour.",
        gl_engine::TextureCompressor::Encoder::FastSplitFusedProjection,
        0 },
    { "split fused projection + clamp",
        "Uses RGB projection, with exact palette evaluation when a modifier would clamp a colour channel.",
        gl_engine::TextureCompressor::Encoder::FastSplitFusedProjectionClamped,
        0 },
    { "split fused exact",
        ...
        0 },
    { "split fused exact + tables",
        "Searches all modifier tables and evaluates all four reconstructed colours for every pixel.",
        gl_engine::TextureCompressor::Encoder::FastSplitFusedExactTableSearch,
        0 },
    { "split bounds",
        ...
        0 },
    { "split bounds projection",
        "Chooses the orientation from colour bounds, then selects modifiers from decoded-base RGB projection.",
        gl_engine::TextureCompressor::Encoder::FastSplitBoundsProjection,
        0 },
    { "split bounds projection + clamp",
        "Uses RGB projection after bounds selection, with exact evaluation when a modifier would clamp.",
        gl_engine::TextureCompressor::Encoder::FastSplitBoundsProjectionClamped,
        0 },
    { "split bounds exact",
        "Chooses the orientation from colour bounds, then evaluates all four table colours per pixel.",
        gl_engine::TextureCompressor::Encoder::FastSplitBoundsExact,
        0 },
    { "split bounds exact + tables",
        "Chooses the orientation from colour bounds, then searches every modifier table with exact pixel evaluation.",
        gl_engine::TextureCompressor::Encoder::FastSplitBoundsExactTableSearch,
        0 },
} };
